...
public class SNSExtendedClient {
    ...
    public void snsExtendedClient (String message) {
        ...
        final AmazonSNSExtendedClient snsExtendedClient = new AmazonSNSExtendedClient(getSNSClient(), (SNSExtendedClientConfiguration) payloadStorageConfiguration);
